...
import Way_img from "../Assets/img/Way-img.png";
import { FaStar } from "react-icons/fa";

import { MdOutlineKeyboardArrowLeft } from "react-icons/md";

const Way = ({ next, setNext }) => {
  return (
    <div className="max-w-[1440px] w-full mx-auto">
      ...
      <div className="sm:mt-[60px] mt-5 gap-8 flex md:flex-row flex-col-reverse w-full justify-evenly items-center ">
        <img src={Way_img} alt="wight-img" className="max-w-[400px] w-full" />
        <div className="flex flex-col gap-5 w-[90%] md:w-[40%]">
          ...
          <div className="text-yellow-300 text-[32px] flex gap-2">
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStar />
          ...
          <p className="sm:text-[18px] text-[14px] text-[#5f5f5f] font-medium font-poppins leading-[110%]">
            " Brilliant gets you hands-on to help improve your proffesional
            skills and knowledge. you'll interact with concept and solve fun
            problem in math,since, and computer science"
          </p>
          <p className="sm:text-[18px] text-[14px] text-[#5f5f5f] font-medium font-poppins leading-[110%]">
            --Jacob S.
          </p>
